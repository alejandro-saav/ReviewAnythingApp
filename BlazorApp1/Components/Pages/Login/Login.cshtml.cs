...
namespace BlazorApp1.Components.Pages.Login;
...
public class Login : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        else
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(jwt)) { ErrorMessage = "Token not received"; return Page(); }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        try
        {
            ...
            ;
            var jwt = loginResponse.Token ?? "";
            if (string.IsNullOrEmpty(jwt)) { ErrorMessage = "Invalid response"; return Page(); }
            Response.Cookies.Append("jwt", jwt, new CookieOptions
            {
                HttpOnly = true,
                Secure = true,
